					...
					<c:forEach items="${to.list}" var="vo">
						<tr>
							...
							<c:choose>
									...
									<c:when test="${login.id!=null}">
										<c:choose>
											<c:when test="${login.id==vo.writer}"> 
												<td><a href="/qboard/read/${vo.bno}?curPage=${to.curPage}">${vo.title}</td>
											</c:when>
											<c:otherwise>
												<td><a class="secretqna" href="redirect:/qboard/listpage?curPage=${curPage}">${vo.title}</button></td>
											</c:otherwise>
									<%--   --%>
										</c:choose>
								...
								<c:otherwise>
									<td><a href="/qboard/read/${vo.bno}?curPage=${to.curPage}">
									<c:choose>
