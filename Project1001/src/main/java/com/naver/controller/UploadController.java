...
public class UploadController {
	...
	@RequestMapping(value = "uploadajaxprod", method = RequestMethod.GET)
	public void uploadajaxprod() {
	}@RequestMapping(value = "uploadajaxprod", method = RequestMethod.POST, produces="text/plain;charset=UTF-8")
	@ResponseBody//ajax통신가능케
	public String uploadajaxprod(MultipartHttpServletRequest request) throws IOException {
		MultipartFile file=request.getFile("file");
		/*
		 * System.out.println(file.getOriginalFilename());
		 * System.out.println(file.getSize());
		 */
		return UploadFileUtils.uploadFileprod(uploadPath, file);
	}
	
	@RequestMapping(value = "uploadajax", method = RequestMethod.GET)
	public void uploadajaxprodui() {
	}
