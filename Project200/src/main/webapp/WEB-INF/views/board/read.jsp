		...
		<div class="row">
			<div id="myModal" class="modal">
				<div class="modal-dialog">
					...
					<div class="modal-footer">
						<button data-dismiss="modal" id="modal_rrepinsert" class="btn btn-warning btn-xs">입력</button>
						<button data-dismiss="modal" id="modal_repclose" class="btn btn-warning btn-xs">취소</button>
					</div>
				</div>
			</div>
		</div>
