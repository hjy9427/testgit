...
public class ReplyController {
	 ...
	 /* 
	 * @RequestMapping(method=RequestMethod.PUT) public String rrep(@RequestBody
	 * ReplyVO vo) { rservice.rrep(vo); return "success rreply"; }
	 * 
	 * @RequestMapping(method=RequestMethod.GET) public String rrepread(ReplyVO vo)
	 * { rservice.rrepread(vo); return "success rread"; }
	 */
