...
import com.board.BListBadcntCommand;
import com.board.BListCommand;
import com.board.BListGoodcntCommand;
...
import com.board.BSearchCommand;
...
import com.member.MDeleteUICommand;
...
import com.member.MSearchIDCommand;
import com.member.MSearchIDUICommand;
import com.member.MSearchPWCommand;
import com.member.MSearchPWUICommand;
...
public class FrontController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		}else if(what.equalsIgnoreCase("/mdeleteui.do")) {
			com = new MDeleteUICommand();
		...
		}else if(what.equalsIgnoreCase("/bsearch.do")) {
			com = new BSearchCommand();
		}else if(what.equalsIgnoreCase("/blistgoodcnt.do")) {
			com = new BListGoodcntCommand();
		}else if(what.equalsIgnoreCase("/blistbadcnt.do")) {
			com = new BListBadcntCommand();
		}else if(what.equalsIgnoreCase("/msearchidui.do")) {
			com = new MSearchIDUICommand();
		}else if(what.equalsIgnoreCase("/msearchid.do")) {
			com = new MSearchIDCommand();
		}else if(what.equalsIgnoreCase("/msearchpwui.do")) {
			com = new MSearchPWUICommand();
		}else if(what.equalsIgnoreCase("/msearchpw.do")) {
			com = new MSearchPWCommand();
		}
