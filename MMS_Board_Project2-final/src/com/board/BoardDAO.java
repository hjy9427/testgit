...
public class BoardDAO {
	...
	public BPageTO listreadcnt(int curPage) {	//조회수 list
		BPageTO to = new BPageTO(curPage);
		List<BoardDTO> list = new ArrayList<BoardDTO>();
		...
		String sql = "select * from"
				+ "(select rownum rnum, num, title, author, to_char(writeday, 'yyyy/mm/dd') writeday, readcnt, repIndent, good, bad from"
				+ "(select * from board3 order by readcnt desc, repRoot desc, repStep asc))"
				+ "where rnum between ? and ?";
		ResultSet rs = null;
		try {
			conn = dataFactory.getConnection();
	...
	public BPageTO listgoodcnt(int curPage) {	//조회수 list
		BPageTO to = new BPageTO(curPage);
		List<BoardDTO> list = new ArrayList<BoardDTO>();
		...
		String sql = "select * from"
				+ "(select rownum rnum, num, title, author, to_char(writeday, 'yyyy/mm/dd') writeday, readcnt, repIndent, good, bad from"
				+ "(select * from board3 order by good desc, repRoot desc, repStep asc))"
				+ "where rnum between ? and ?";
		ResultSet rs = null;
		try {
			conn = dataFactory.getConnection();
	...
	public BPageTO listbadcnt(int curPage) {	//조회수 list
		BPageTO to = new BPageTO(curPage);
		List<BoardDTO> list = new ArrayList<BoardDTO>();
		...
		String sql = "select * from"
				+ "(select rownum rnum, num, title, author, to_char(writeday, 'yyyy/mm/dd') writeday, readcnt, repIndent, good, bad from"
				+ "(select * from board3 order by bad desc, repRoot desc, repStep asc))"
				+ "where rnum between ? and ?";
		ResultSet rs = null;
		try {
			conn = dataFactory.getConnection();
